    ...
    <main style={{ fontFamily:"'DM Sans',sans-serif", background:'#FEFEF8', color:'#3E2723', overflowX:'hidden' }}>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .lk{display:inline-flex;align-items:center;gap:10px;font-size:.9rem;font-weight:500;border-bottom:1px solid;padding-bottom:4px;transition:gap .3s,border-color .3s,color .3s}
        ...
        /* Each step */
        .t-step{position:relative;margin-bottom:0;padding:0 0 64px 0}
        ...
        .t-dot.lit{
          width:20px;height:20px;left:-50px;top:18px;
        }
        ...
        .t-title{font-family:'Playfair Display',serif;font-size:1.35rem;color:rgba(254,254,248,.9);margin-bottom:10px;line-height:1.25;transition:color .4s}
        ...
        .bg{font-size:.9rem;background:transparent;color:#FEFEF8;padding:15px 36px;border-radius:2px;border:1.5px solid rgba(254,254,248,.2);transition:all .3s}
        .bg:hover{border-color:rgba(254,254,248,.6)}
        ...
        /* AUTH MODAL */
        .auth-ov{position:fixed;inset:0;z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px;background:rgba(28,14,8,.72);backdrop-filter:blur(10px);animation:fade-in .22s ease}
        ...
        .auth-tabs{display:flex;gap:0;margin:28px 40px 0;border-bottom:1px solid #D4C4B0}
        ...
        .auth-submit{margin-top:8px;padding:13px;background:#3E2723;color:#FEFEF8;border:none;border-radius:2px;font-size:.9rem;font-weight:500;cursor:pointer;font-family:inherit;transition:all .25s}
        .auth-submit:hover{background:#2C1810;transform:translateY(-1px)}
        .auth-switch{text-align:center;font-size:.82rem;color:#8D8D8D;margin-top:4px}
        ...
        .auth-divider{display:flex;align-items:center;gap:12px;color:#D4C4B0;font-size:.78rem}
        .auth-divider::before,.auth-divider::after{content:'';flex:1;height:1px;background:#D4C4B0}
      `}</style>
      ...
      <section className="hero">
        ...
        <div className="hero-ct">
          ...
          <a href="#why" className="ha d4 lk lk-lt">Discover our approach →</a>
        </div>
      </section>
      ...
      <div className="stats">
        {[
          ...
          {n:'$500k',em:'',u:'Saved Annually',d:'Eliminate consultant fees, staff overtime, and rework costs entirely.'},
        ].map((s,i)=>(
          <R key={i} d={i*100}>
            <div className="stat">
      ...
      <section id="features" className="eaas">
        <div className="eaas-i">
          <img src="https://images.unsplash.com/photo-1440342359743-84fcb8c21f21?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8c3VzdGFpbmFiaWxpdHl8ZW58MHx8MHx8fDA%3D" alt="Wind farm"/>
        </div>
        <div className="eaas-t">
          <R t="r">
            ...
            <a href="#contact" className="lk lk-lt" style={{marginTop:'32px'}}>Contact our team →</a>
          </R>
        </div>
      </section>
      ...
      <section className="cta">
        <R>
          ...
          <div className="cta-ac">
            <button className="bf">Explore the Platform</button>
      ...
      {/* AUTH MODAL */}
      {authOpen && (
        <div className="auth-ov" onClick={e=>{if(e.target===e.currentTarget)setAuthOpen(false)}}>
          <div className="auth-box">
            <div className="auth-hd">
              <span className="auth-logo">Truvexis</span>
              <button className="auth-x" onClick={()=>setAuthOpen(false)}>✕</button>
            </div>
            ...
            <div className="auth-body">
              {authTab==='signup' && (<>
                ...
                <div className="auth-field">
                  ...
                  <select className="auth-input" value={authForm.industry}
              ...
              <div className={authTab==='signup' ? 'auth-pw-row' : ''} style={authTab==='signup'?{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'16px'}:{}}>
                <div className="auth-field">
              ...
              {authTab==='signup' && authForm.confirm && authForm.confirm!==authForm.password && (
                <p style={{fontSize:'.78rem',color:'#C0392B',marginTop:'-8px'}}>Passwords do not match</p>
              )}
              ...
              <p className="auth-switch">
                {authTab==='signin'
                  ? <>Don't have an account? <button onClick={()=>setAuthTab('signup')}>Sign up free</button></>
                  : <>Already have an account? <button onClick={()=>setAuthTab('signin')}>Sign in</button></>}
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="ft">
        <div className="ft-in">
          ...
          <div className="ft-md">Built by Yash Dusane . 2025 .</div>
          <div className="ft-lk">
...
// ── Pipeline step with scroll-triggered reveal ──
  ...
  return (
    ...
    >
      ...
      <div
        className="t-dot"
        style={{
          borderColor: lit ? step.color : 'rgba(255,255,255,0.15)',
          background: lit ? step.color : '#1C1008',
          boxShadow: lit ? `0 0 16px ${step.color}60` : 'none',
        }}
      />
      ...
      <div className="t-card" style={{ borderColor: lit ? `${step.color}25` : 'rgba(255,255,255,0.07)' }}>
        ...
        <div
          className="t-icon"
          style={{
            background: lit ? step.bg : 'rgba(255,255,255,0.04)',
            color: lit ? step.color : 'rgba(255,255,255,0.2)',
            border: `1px solid ${lit ? step.color + '40' : 'rgba(255,255,255,0.08)'}`,
          }}
        >
          {step.icon}
        </div>
        ...
        {/* Text */}
        <div>
          <div className="t-meta" style={{ color: lit ? step.color : 'rgba(255,255,255,0.25)' }}>
            Step {step.n}
          </div>
